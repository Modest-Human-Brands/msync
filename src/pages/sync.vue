...
const isImage = (file?: MediaFile) => !!file && (file.type.startsWith("image") || ["png", "jpg", "jpeg", "webp", "gif"].includes(file.type.toLowerCase()));
      ...
      <div class="w-[45%] overflow-y-auto p-1">
        <div class="grid grid-cols-3 gap-2">
          <div v-for="(item, i) in mediaFiles" :key="item.path" @click="selectedIndex = i"
            ...
            <div v-else class="w-full h-24 flex items-center justify-center text-2xs text-gray-500">
              {{ item.type || 'FILE' }}
            </div>
